...
export function drawExperience(ctx, x = 0, y = 0, width = 100, thickness = 10, progress = 1, mainColor = "rgba(9, 107, 0, 1)", backgroundColor = 'rgba(113, 113, 113, 1)', borderColor = 'rgba(255, 255, 255, 1)') {
    ctx.save();
